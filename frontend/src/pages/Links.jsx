...
export default function Links() {
    ...
    return (
        <div className="page">
            {/* ═══ HEADER ═══ */}
            <div style={{ fontSize: '0.6em', fontWeight: 700, color: 'var(--text-muted)', letterSpacing: 2, textTransform: 'uppercase', marginBottom: 2 }}>RESOURCES / LINKS</div>
            ...
            {showPaste && (
                <div className="card" style={{ marginBottom: 16, padding: '16px 20px' }}>
                    ...
                    <div>
                        <label style={{ fontSize: '0.72em', fontWeight: 600, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: 0.5 }}>Links (one per line)</label>
            ...
            {packs.length === 0 ? (
                <div className="card" style={{ textAlign: 'center', padding: '48px 24px', color: 'var(--text-muted)' }}>
                    ...
                    <div style={{ fontSize: '1em', fontWeight: 700, marginBottom: 4 }}>No Link Packs</div>
                    <div style={{ fontSize: '0.82em' }}>Upload a .txt file with links to get started</div>
                </div>
            ) : (
