...
COUNTRIES = [
    ...
    {"code": "US", "name": "United States", "name_ru": "США", "lang": "en", "tz": "America/New_York", "simsms": 12},
    {"code": "GB", "name": "United Kingdom", "name_ru": "Великобритания", "lang": "en", "tz": "Europe/London", "simsms": 16},
    {"code": "CA", "name": "Canada", "name_ru": "Канада", "lang": "en", "tz": "America/Toronto", "simsms": 36},
    ...
    {"code": "IE", "name": "Ireland", "name_ru": "Ирландия", "lang": "en", "tz": "Europe/Dublin", "simsms": 23},
    # German-speaking
    {"code": "DE", "name": "Germany", "name_ru": "Германия", "lang": "de", "tz": "Europe/Berlin", "simsms": 43},
    {"code": "AT", "name": "Austria", "name_ru": "Австрия", "lang": "de", "tz": "Europe/Vienna", "simsms": 50},
    # French-speaking
    {"code": "FR", "name": "France", "name_ru": "Франция", "lang": "fr", "tz": "Europe/Paris", "simsms": 22},
    ...
    # Spanish-speaking
    {"code": "ES", "name": "Spain", "name_ru": "Испания", "lang": "es", "tz": "Europe/Madrid", "simsms": 56},
    {"code": "MX", "name": "Mexico", "name_ru": "Мексика", "lang": "es", "tz": "America/Mexico_City", "simsms": 54},
    {"code": "AR", "name": "Argentina", "name_ru": "Аргентина", "lang": "es", "tz": "America/Buenos_Aires", "simsms": 39},
    {"code": "PE", "name": "Peru", "name_ru": "Перу", "lang": "es", "tz": "America/Lima", "simsms": 65},
    ...
    # Portuguese-speaking
    {"code": "BR", "name": "Brazil", "name_ru": "Бразилия", "lang": "pt", "tz": "America/Sao_Paulo", "simsms": 10},
    # Russian-speaking
    {"code": "RU", "name": "Russia", "name_ru": "Россия", "lang": "ru", "tz": "Europe/Moscow", "simsms": 0},
    {"code": "UA", "name": "Ukraine", "name_ru": "Украина", "lang": "uk", "tz": "Europe/Kiev", "simsms": 1},
    {"code": "BY", "name": "Belarus", "name_ru": "Беларусь", "lang": "ru", "tz": "Europe/Minsk", "simsms": 7},
    {"code": "KZ", "name": "Kazakhstan", "name_ru": "Казахстан", "lang": "ru", "tz": "Asia/Almaty", "simsms": 2},
    ...
    # Turkish
    {"code": "TR", "name": "Turkey", "name_ru": "Турция", "lang": "tr", "tz": "Europe/Istanbul", "simsms": 62},
    # Arabic-speaking
    {"code": "SA", "name": "Saudi Arabia", "name_ru": "Сауд. Аравия", "lang": "ar", "tz": "Asia/Riyadh", "simsms": 53},
    {"code": "EG", "name": "Egypt", "name_ru": "Египет", "lang": "ar", "tz": "Africa/Cairo", "simsms": 21},
    ...
    # African
    {"code": "NG", "name": "Nigeria", "name_ru": "Нигерия", "lang": "en", "tz": "Africa/Lagos", "simsms": 19},
    {"code": "ZA", "name": "South Africa", "name_ru": "ЮАР", "lang": "en", "tz": "Africa/Johannesburg", "simsms": 31},
    {"code": "GH", "name": "Ghana", "name_ru": "Гана", "lang": "en", "tz": "Africa/Accra", "simsms": 38},
    {"code": "KE", "name": "Kenya", "name_ru": "Кения", "lang": "en", "tz": "Africa/Nairobi", "simsms": 8},
    {"code": "ET", "name": "Ethiopia", "name_ru": "Эфиопия", "lang": "am", "tz": "Africa/Addis_Ababa", "simsms": 71},
    # Asian
    {"code": "CN", "name": "China", "name_ru": "Китай", "lang": "zh", "tz": "Asia/Shanghai", "simsms": 3},
    {"code": "PH", "name": "Philippines", "name_ru": "Филиппины", "lang": "tl", "tz": "Asia/Manila", "simsms": 4},
    {"code": "ID", "name": "Indonesia", "name_ru": "Индонезия", "lang": "id", "tz": "Asia/Jakarta", "simsms": 6},
    {"code": "TH", "name": "Thailand", "name_ru": "Таиланд", "lang": "th", "tz": "Asia/Bangkok", "simsms": 52},
    ...
    {"code": "IL", "name": "Israel", "name_ru": "Израиль", "lang": "he", "tz": "Asia/Jerusalem", "simsms": 13},
    # European
    {"code": "NL", "name": "Netherlands", "name_ru": "Нидерланды", "lang": "nl", "tz": "Europe/Amsterdam", "simsms": 48},
    {"code": "PL", "name": "Poland", "name_ru": "Польша", "lang": "pl", "tz": "Europe/Warsaw", "simsms": 15},
    {"code": "RO", "name": "Romania", "name_ru": "Румыния", "lang": "ro", "tz": "Europe/Bucharest", "simsms": 32},
    {"code": "SE", "name": "Sweden", "name_ru": "Швеция", "lang": "sv", "tz": "Europe/Stockholm", "simsms": 33},
    {"code": "FI", "name": "Finland", "name_ru": "Финляндия", "lang": "fi", "tz": "Europe/Helsinki", "simsms": 18},
    {"code": "EE", "name": "Estonia", "name_ru": "Эстония", "lang": "et", "tz": "Europe/Tallinn", "simsms": 34},
    ...
    {"code": "CZ", "name": "Czechia", "name_ru": "Чехия", "lang": "cs", "tz": "Europe/Prague", "simsms": 63},
    # Caribbean / Other
...
LANGUAGES = [
    ...
    {"code": "zh", "name": "Chinese", "name_ru": "Китайский"},
